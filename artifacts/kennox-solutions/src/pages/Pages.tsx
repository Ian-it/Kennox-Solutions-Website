  ...
  return (
    <>
      <section className="relative">
        <div className="page-wrap flex flex-col justify-center pb-10 pt-6 sm:min-h-[calc(100dvh-76px)] sm:pb-24 sm:pt-8">
        ...
        <KennoxMarquee className="static mt-6 sm:absolute sm:inset-x-0 sm:bottom-0 sm:mt-0" />
      </section>
